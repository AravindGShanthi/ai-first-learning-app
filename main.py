...
async def main():
    ...
    lesson_plan_refiner_agent = Agent(
        ...
        instruction="""
            ...
            1.1. Generated Plan (generated_plan): The original lesson plan array from the generator agent (["Day 1 Topic", "Day 2 Topic", ...]).
            1.2. Reviewer feedback (reviewer_output): Feedback provided by the Lesson Plan Reviewer Agent. It may include:
